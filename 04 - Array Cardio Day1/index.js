...
// * 1-1. callback function return
const fifteen = inventors.filter(function (inventor) {
  if (inventor.year >= 1500 && inventor.year < 1600) {
    return true; // keep it!
  }
});
// * 1-2. return a boolean of true
...
// * 4-2. reduce method
const totalYears2 = inventors.reduce(
...
// const links = Array.from(category.querySelectorAll("a")); // more readable than spread?
// // const links = [...category.querySelectorAll("a")];
// const de = links
//   .map((link) => link.textContent)
//   .filter((sstreetName) => sstreetName.includes("de"));
